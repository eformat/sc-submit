                    ...
                    steps {
                        script {
                            ...
                            if [ $rc -eq 1 ]; then
                                ...
                                oc new-app --template=mysql-persistent -p MYSQL_VERSION=latest -p DATABASE_SERVICE_NAME=tripvibe -p MYSQL_USER=tripvibe -p MYSQL_PASSWORD=password -p MYSQL_DATABASE=tripvibe -p MYSQL_ROOT_PASSWORD=password -p VOLUME_CAPACITY=5Gi --name=mysql
                                sleep 10
